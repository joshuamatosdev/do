...
- `agents/` = 10 dispatchable subagents · `skills/` = 15 in-repo skills (4 more ship with modules,
  19 total per README) · `workflows/` = 3 deterministic multi-agent scripts (`adr-spec.js`,
