...
const SPINE_FILES = [
  ...
  ["policy/terminal-discipline.md", ".claude/do/terminal-discipline.md"], // terminal-state discipline (the spec behind the terminal-check skill + the RESPONSE-FORMAT self-check)
];
