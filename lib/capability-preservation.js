...
// Thin CLI: read {diffText, turnText, baseline, groundedIds, preexistingContracts} JSON on stdin,
// print the verdict JSON on stdout, exit 0 always (the caller decides what to do with `allow`).
